...
public func fetchAccountPeer(account: Account) {
    let messageId = MessageId(peerId: PeerId(namespace: PeerId.Namespace._internalFromInt32Value(Int32.max), id: PeerId.Id._internalFromInt32Value(0)), namespace: 0, id: 1)
