...
final class AccountManagerImpl<Types: AccountManagerTypes> {
    ...
    fileprivate init?(queue: Queue, basePath: String, isTemporary: Bool, isReadOnly: Bool, useCaches: Bool, temporarySessionId: Int64, hiddenAccountManager: HiddenAccountManager) {
...
public final class AccountManager<Types: AccountManagerTypes> {
    ...
    public init(basePath: String, isTemporary: Bool, isReadOnly: Bool, useCaches: Bool, hiddenAccountManager: HiddenAccountManager) {
        ...
        self.impl = QueueLocalObject(queue: queue, generate: {
            if let value = AccountManagerImpl<Types>(queue: queue, basePath: basePath, isTemporary: isTemporary, isReadOnly: isReadOnly, useCaches: useCaches, temporarySessionId: temporarySessionId, hiddenAccountManager: hiddenAccountManager) {
                return value
            } else {
                preconditionFailure()
            }
